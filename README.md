...
Also, I really like the coding style of Unity - it uses *Pascal Case (UpperCamelCase)* for methods - seems more legible IMO. So everything specific to ofxVui uses Pascal Case :)
***
###### *[TODO](#todo)* 
